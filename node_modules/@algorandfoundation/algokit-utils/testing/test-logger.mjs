...
class TestLogger {
    ...
    getLogSnapshot(config) {
        ...
        accounts?.forEach((sender, id) => (snapshot = snapshot.replace(new RegExp(typeof sender === 'string' ? sender : 'addr' in sender ? sender.addr : sender.address(), 'g'), `ACCOUNT_${id + 1}`)));
...
export { TestLogger };
//# sourceMappingURL=test-logger.mjs.map
